...
def main():
    my_survey = CualitativeSurvey(filename="prueba_4_escalada", p_id="001")
    my_survey.init_csv()
    ...
    my_eeg = EEGRecorder(duration=10, filename="prueba_4_eeg_parpadeoespaciado_escalada", r_id="001")
